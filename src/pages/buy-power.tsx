...
const BuyPower: NextPage = () => {
  ...
  const [disableButton, setDisableButton] = useState(
    "disabled bg-[#7c7c7c] pointer-events-none"
  );
      ...
      <Dialog open={metaverseDialog}>
        <DialogContent className="bg-[#1a1a1a] border-none shadow-lg">
          <DialogTitle className="text-3xl flex text-white pb-2 gap-3">
            {" "}
            Warning: Metaverse ahead!
          </DialogTitle>
          <p className="font-semibold">
            In the real world, drivers shouldn't need to buy their gas (or
            energy) on a website before filling their tank up. This also apply
            to DeVolt, obviously.
          </p>
          <p className="">
            Keep in mind that this page only simulates what a driver would do in
            a charge station. In the real scenario, the driver would just pull
            up to the station, plug their car in, connect his/her wallet and
            choose the amount of energy to buy.
          </p>
          <button
