...
const MapSectionHomepage = () => {
  ...
  const [closestStationDistance, setClosestStationDistance] = useState<
    string | number
  >(0);
        ...
        <div className="leading-[0]">
          <p className="text-2xl font-bold">
            ...
            <span className="font-normal text-xl">
              {closestStationDistance}Km
            </span>
          </p>
          <p className="text-lg font-semibold">Energy available:</p>
          <Progress
            value={closestStation?.availableEnergyPercentage || 50}
          ...
          <div className="flex gap-4">
            <a
              ...
              href={`https://www.google.com/maps/search/${
                closestStation?.latitude || 0
              },+${closestStation?.longitude || 0}?entry=tts`}
            >
