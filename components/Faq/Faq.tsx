            ...
            <div className="px-12 md:px-12 mt-4 md:mt-12 max-w-screen-2xl w-full">
                <Accordion type="single" collapsible className="w-full">
                    <AccordionItem value="item-1">
                        <AccordionTrigger className="text-lg md:text-2xl">How do I start selling energy with DeVolt?</AccordionTrigger>
                    ...
                    <AccordionItem value="item-2">
                        <AccordionTrigger className="text-lg md:text-2xl">What are the benefits of using DeVolt for EV charging?</AccordionTrigger>
                        <AccordionContent className="text-neutral-400">
                    ...
                    <AccordionItem value="item-3">
                        <AccordionTrigger className="text-lg md:text-2xl">Is the DeVolt platform secure?</AccordionTrigger>
                        <AccordionContent className="text-neutral-400">
                    ...
                    <AccordionItem value="item-4">
                        <AccordionTrigger className="text-lg md:text-2xl">What advantages does DeVolt offer over traditional energy solutions?</AccordionTrigger>
                        <AccordionContent className="text-neutral-400">
                    ...
                    <AccordionItem value="item-5">
                        <AccordionTrigger className="text-lg md:text-2xl">Can anyone install a DeVolt charging station?</AccordionTrigger>
                        <AccordionContent className="text-neutral-400">
                    ...
                    <AccordionItem value="item-6">
                        <AccordionTrigger className="text-lg md:text-2xl">How does DeVolt handle energy pricing?</AccordionTrigger>
                        <AccordionContent className="text-neutral-400">
                    ...
                    <AccordionItem value="item-7">
                        <AccordionTrigger className="text-lg md:text-2xl">What types of energy can be sold on DeVolt?</AccordionTrigger>
                        <AccordionContent className="text-neutral-400">
                    ...
                    <AccordionItem value="item-10">
                        <AccordionTrigger className="text-lg md:text-2xl">What is required to maintain a DeVolt charging station?</AccordionTrigger>
                        <AccordionContent className="text-neutral-400">
