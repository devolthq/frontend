			...
			<div className="relative z-1">
				<div className="text-center pt-16">
					...
					<motion.p
						...
						transition={{ duration: 1, delay: 3 }}
					>
						DeVolt is a descentralized solution focused on providing
					...
					>
						...
						>
							<Button
								variant={"secondary"}
								onClick={openModal}
								className="hover:scale-105 transition shadow-md shadow-[#3a583a] animate-accordion-up animate-infinite"
							>
								Watch the video
								<PlayIcon
									fill="#fff"
